	...
	.protected	explicit_read   ; -- Begin function explicit_read
	.globl	explicit_read
	.p2align	8
	.type	explicit_read,@function
	.amdgpu_hsa_kernel explicit_read
...
; %bb.0:
	...
	s_endpgm
.Lfunc_end0:
	.size	explicit_read, .Lfunc_end0-explicit_read
                                        ; -- End function
